...
export const API = {
  ...
  attachmentIssue:       (pid: string, fid: string)               => `/api/projects/${pid}/attachments/${fid}/issue`,
  attachmentRevisions:   (pid: string, fid: string)               => `/api/projects/${pid}/attachments/${fid}/revisions`,
