...
vi.mock("@/lib/queries", () => ({
  ...
  divisionBelongsToOrg: vi.fn().mockResolvedValue(true),
  ...
  getDesignDisciplines: vi.fn().mockResolvedValue([]),
  seedDesignPackages: vi.fn().mockResolvedValue(undefined),
  getDesignPackages: vi.fn().mockResolvedValue([]),
  ...
  getBestRateForElements: vi.fn().mockResolvedValue({}),
  ...
  markVendorDistributionMixed: vi.fn().mockResolvedValue(undefined),
  ...
  AUDIT_ACTIONS: {
    ...
    RATE_CONTRACT_CREATED: "rate_contract.created",
    RATE_CONTRACT_UPDATED: "rate_contract.updated",
