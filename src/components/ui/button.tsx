...
const variantStyles: Record<ButtonVariant, string> = {
  primary:
    "bg-accent-button text-text-on-accent hover:bg-accent-button-hover font-semibold",
  secondary:
  ...
  (
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "inline-flex items-center justify-center rounded-lg transition-[color,background-color,border-color,transform] duration-150 cursor-pointer active:scale-[0.98] motion-reduce:active:scale-100 disabled:opacity-50 disabled:grayscale disabled:cursor-not-allowed",
