...
> **Status (2026-07-22):** PR-1 (#216), PR-2 (#217), and PR-3 (#222) shipped and merged — live behind the `designDocumentControl` PostHog flag (0% / dormant). Migrations applied to dev/staging and prod. PR-4–PR-6 not started.
